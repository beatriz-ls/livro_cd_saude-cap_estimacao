...
É fundamental que a amostra seja suficientemente precisa para tornar possível a realização de inferências confiáveis. 
Uma amostra adequada deve ter poder estatístico suficiente para detectar diferenças ou efeitos presentes na população, bem como,  precisão adequada, normalmente avaliada pela margem de erro cálculada pelo erro quadrático médio.
...
Neste capítulo, será apresentado métodos de cálculo amostral para planejamentos experimentais 
